    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-6 relative bg-zinc-950 text-zinc-100 selection:bg-zinc-800">
      ...
      <div className="flex flex-col items-center w-full max-w-md space-y-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full">
          <Link
            href="/new-project?mode=B"
            className="flex-1"
          >
            <button className="w-full h-12 bg-zinc-100 hover:bg-white text-zinc-950 font-medium rounded-lg transition-all duration-200 ease-in-out shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.2)]">
              Upload Full Model
            </button>
          </Link>
